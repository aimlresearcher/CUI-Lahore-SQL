...
-- Commonly used to extract the year, month, day, hour, minute, second, etc.
...
SELECT SWITCHOFFSET(SYSDATETIMEOFFSET(), '-05:00') AS DateTimeOffsetInDifferentTimeZone;

-- DATEDIFF_BIG():
-- Similar to DATEDIFF but supports a larger range of date and time values.
SELECT DATEDIFF_BIG(SECOND, '19000101', GETDATE()) AS SecondsSince1900;